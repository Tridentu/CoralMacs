...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(completions-annotations ((,class (:foreground ,background))))
   `(completions-common-part ((,class (:foreground , background :weight bold))))
   ...
   ;; > Company
   `(company-echo-common ((t (:foreground ,background :background , foreground))))
   `(company-tooltip ((t (:inherit default :background, foreground))))
   `(company-tooltip-common ((t (:foreground ,background :background, foreground))))
   `(company-preview ((,class (:foreground , background :background , foreground))))
